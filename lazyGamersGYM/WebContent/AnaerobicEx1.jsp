	...
	<div data-role="page" id="Squat">
		...
		<div Role="main" class="ui-content">
			...
			<div data-role="content">
				<br>
				<p>Lie on your back on the glideboard with your feet on the
					squat stand, knees at 90 degree angles.</p>
				<p>Slide the glideboard up by straightening your legs and allow
					yourself back down after a short pause.</p>
				<p>Breathe out while straightening your legs and breathe in
					while returning to starting position.</p>
				<p>
				...
				<form method="POST"
					action="/lazyGamersGYM/controller/createActivity/Squat">
